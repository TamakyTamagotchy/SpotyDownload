...
class DownloadPage(QWidget):
    """Página de descargas con diseño moderno y validación estricta de Spotify."""
    ...
    def init_ui(self):
        ...
        empty_text.setStyleSheet("color: #FFFFFF;")
    ...
    def add_to_queue(self):
        ...
        if not link or "spotify.com" not in link:
            toast.warning("Ingresa un enlace válido de Spotify")
        ...
        try:
            ...
            self.url_input.set_error(False)
